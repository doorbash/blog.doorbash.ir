...
تا اینجا تقریبا تمومه . ولی یه نکته ای مونده. اونم اینکه پکت ها الان با آدرس منبع خودشون دارن از طرف ما برای مودم ها ارسال میشن و ما این رو نمیخایم. ما میخایم پکت از آدرس IP ما برای مودم فرستاده بشه تا موقع برگشت هم دوباره برای خودمون بفرسته. برای همین میایم از این دستور استفاده میکنیم:
...
بعدا حتی میتونیم کاری کنیم بر اساس وضعیت شبکه پکت ها به نسبت وزنی که به هر شبکه اختصاص میدیم مسیریابی بشن. یا مثلا اگر پینگ یکی از شبکه ها افتضاح بود کلا ازش استفاده نکنه.
